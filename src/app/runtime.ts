...
export class BotRuntime {
  ...
  private createAgentTools(params: {
    ...
    return {
      ...
      execute: tool({
        description:
          "Run JavaScript in QuickJS runtime (supports async/await, fetch, fs.read/fs.write/fs.list/fs.remove, memory.*, and google.execute which returns { ok, status, result }). Return the final value you want back; console.log only adds logs. If you use await or multiple statements, explicitly `return` the final value.",
